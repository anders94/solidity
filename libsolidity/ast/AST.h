...
public:
	...
	/// @param _external true indicates external interface is concerned, false indicates internal interface is concerned.
	/// @returns null when it is not accessible as a function.
	virtual std::shared_ptr<FunctionType const> functionType(bool /*_external*/) const { return {}; }
